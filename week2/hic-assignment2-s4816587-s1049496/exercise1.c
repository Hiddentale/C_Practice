...
int main(void) {
	...
	https://personalpages.surrey.ac.uk/r.bowden/C/printf.html
	...
	printf("%p\t\ti\t%" PRId8 "\t%zu\t%p\n", (void*) &i, i, sizeof(i), (void*)(&i+1));

	return 0;
}

// https://en.cppreference.com/w/cpp/language/sizeof says sizeof() gives us the total amount of bytes that
// a variable takes in memory. Since f is an array of 3 shorts, and a short is 2 bytes, it follows naturally
// that f is 6 bytes long.
